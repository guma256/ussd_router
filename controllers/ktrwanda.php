...
class Ktrwanda extends Controller {
    ...
    function Index() {
	  ...
	  //$this->model->log->ExeLog($standard_array, 'Ktrwanda::Index Initial Request ' . var_export($decodeddata, true), 1);
